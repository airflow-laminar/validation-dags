...
lint-py:  ## lint python with ruff
	python -m ruff check validation_dags
	python -m ruff format --check validation_dags
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix validation_dags
	python -m ruff format validation_dags
...
test:  ## run python tests
	python -m pytest -v validation_dags/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v validation_dags/tests --cov=validation_dags --cov-report term-missing --cov-report xml
